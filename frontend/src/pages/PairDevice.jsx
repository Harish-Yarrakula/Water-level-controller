  ...
  return (
    <div className="isolate bg-white py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-4xl font-semibold tracking-tight text-balance text-gray-900 sm:text-5xl">Pair Device</h2>
        <p className="mt-2 text-lg/8 text-gray-600">Pair your device here with the details</p>
      </div>
      <form method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20" onSubmit={handleSubmit}>
